...
/**
 * \defgroup    GPIO_BitAction GPIO BitAction
 * \{
 * \ingroup     GPIO_Exported_Constants
 */
typedef enum
...
/**
 * \defgroup    GPIO_INT_Trigger_Level GPIO INT Trigger Level
 * \{
 * \ingroup     GPIO_Exported_Constants
 */
typedef enum
...
/**
 * \defgroup    GPIO_INT_Polarity GPIO INT Polarity
 * \{
 * \ingroup     GPIO_Exported_Constants
 */
typedef enum
...
/**
 * \defgroup    GPIO_INT_Debounce GPIO INT Debounce
 * \{
 * \ingroup     GPIO_Exported_Constants
 */
typedef enum
...
#define IS_GPIOIT_MODE(TYPE) (((TYPE) == GPIO_SOFTWARE_MODE)\
...
typedef struct
{
    ...
    GPIOMode_TypeDef
    GPIO_Mode;                                  /**< Specify the operating mode for the selected pins. */
    ...
    GPIOControlMode_Typedef   GPIO_ControlMode; /**< Specify the gpio control mode. */
    uint32_t GPIO_DebounceTime;                 /**< Specify the gpio debounce time (ms). */
} GPIO_InitTypeDef;
 ...
 * \param[in]  GPIO_Pin: GPIO selected pin GPIO_Pin_x, where x can be 0 or 31,
 *                       refer to \ref GPIO_Pins_Define.
 ...
 * \return  GPIO_Pin_x for GPIO initialization, where x can be 0 or 31, refer to \ref GPIO_Pins_Define.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 * \param[in] Pin_num: Pad num which can be from P0_0 to H_2, please refer to rtl876x.h "Pin_Number" part.
 * \return  GPIOx(x is 0~31) value, which refer to \ref GPIO_Number.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 * \param[in] NewState: New state of the debounce clock.
 ...
 *      This parameter can be GPIO_Pin_x where x can be 0~31, refer to \ref GPIO_Pins_Define.
 ...
 *      This parameter can be GPIO_Pin_x where x can be 0~31 or GPIO_Pin_All, refer to \ref GPIO_Pins_Define.
 * \return None.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * \param[in] GPIO_Pin: Specify the port bit to be written.
 *      This parameter can be one of GPIO_Pin_x where x can be 0~31, refer to \ref GPIO_Pins_Define.
 * \param[in] BitVal: Specify the value to be written to the selected bit.
 *      This parameter can be one of the BitAction enum values, which refer to \ref GPIO_BitAction.
 ...
 * \param[in] DebounceTime: Specify interrupt debounce time, the unit is ms.
 *      This parameter can be 1 ~ 64.
 * \return None.
 *
 * <b>Example usage</b>
 * \code{.c}
...
typedef struct
{
    uint32_t gpio_reg[GPIO_DLPS_MAX];
