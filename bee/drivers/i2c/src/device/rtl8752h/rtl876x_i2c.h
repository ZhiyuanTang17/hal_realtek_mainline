...
typedef struct
{
    uint32_t I2C_Clock;             /*!< Specify the clock frequency, default 40000000.
                                            This parameter must be set with I2C clock div. */
    uint32_t I2C_ClockSpeed;        /*!< Specify the clock frequency.
                                            This parameter must be set to a value lower than 1000000Hz. */
    uint16_t I2C_DeviveMode;        /*!< Specify the I2C device mode.
                                            This parameter can be a value of \ref I2C_Device_Mode. */
    uint16_t I2C_AddressMode;       /*!< Specify the I2C address mode.
                                            This parameter can be a value of \ref I2C_Address_Mode. */
    uint16_t I2C_SlaveAddress;      /*!< Specify the slave device address.
                                            This parameter can be a 7-bit or 10-bit address. */
    uint16_t I2C_Ack;               /*!< Enable or disable the acknowledgement only in slave mode.
    ...
    uint16_t I2C_TxDmaEn;           /*!< Specify the Tx DMA mode.
                                            This parameter can be a value of ENABLE or DISABLE. */
    uint16_t I2C_RxDmaEn;           /*!< Specify the Rx DMA mode.
                                            This parameter can be a value of ENABLE or DISABLE. */
    uint8_t  I2C_TxWaterlevel;      /*!< Specify the DMA Tx water level.
                                            Best to equal Tx FIFO minus GDMA Dest MSize. */
    uint8_t  I2C_RxWaterlevel;      /*!< Specify the DMA Rx water level.
                                            Best to equal GDMA Source MSize. */
} I2C_InitTypeDef;

/** End of I2C_Exported_Types
  * \}
  */
 ...
 */
#define IS_I2C_CLOCK_SPEED(SPEED) (((SPEED) >= 0x01) && ((SPEED) <= 1000000))
 ...
 * \param[in] I2Cx: Where x can be 0 or 1 to select the I2C peripheral.
 * \param[in] I2C_InitStruct: Pointer to an I2C_InitTypeDef structure that
 ...
 * \return The status of I2Cx, which refers to \ref I2C_Status.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 * \return  The status of I2Cx, which refers to \ref I2C_Status.
 * \note Attention: Read data with time-out mechanism.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 * \param[in] I2Cx: Where x can be 0 or 1 to select the I2C peripheral.
 * \param[in] Address: Specify the slave address which will be transmitted.
 * \return  None.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 *      \arg I2C_READ_CMD: means this is a read command.
 *      \arg I2C_WRITE_CMD: means this is a write command.
 * \param[in] data: Data which is to be transmitted.
 * \param[in] StopState: send stop signal or not.
 ...
 * \param[in] I2Cx: where x can be 0 or 1 to select the I2C peripheral.
 * \return  The data length in Rx FIFO.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 * \param[in] I2Cx: where x can be 0 or 1 to select the I2C peripheral.
 * \return  The data length in Tx FIFO.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
...
/**
 * \brief   Clear all I2C interrupts.
 * \param[in] I2Cx: where x can be 0 or 1 to select the I2C peripheral.
 * \return  None.
 *
 * <b>Example usage</b>
 ...
 *      This parameter can be one of the following values, which refer to \ref I2C_Flags_Definition.
