...
typedef struct
{
    ...
    uint16_t debouncecnt;        /*!< Specify Keyscan debounce time, debounce time = delay clock * debouncecnt. */
    uint16_t releasecnt;         /*!< Specify Keyscan release time, release time = delay clock * releasecnt. */
