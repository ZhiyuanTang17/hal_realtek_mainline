...
typedef struct
{
    uint32_t ADC_SampleTime;        /**< Specify the ADC sample clock, adc_sample_period = (n+1) cycles from 10MHz.
                                            This parameter can be a value of 19 to 16383. */
    uint32_t ADC_ConvertTime;       /**< Specify the ADC Sample convert time.
    ...
    uint32_t ADC_FifoThdLevel;      /**< Specify the ADC FIFO threshold to trigger \ref ADC_INT_FIFO_THD interrupt.
                                            This parameter can be a value of 0 to 31. */
    uint32_t ADC_WaterLevel;        /**< Specify the ADC FIFO burst size to trigger GDMA.
                                            This parameter can be a value of 0 to 31. */
    uint32_t ADC_FifoOverWriteEn;   /**< Specify if over write FIFO when FIFO overflow.
                                            This parameter can be a value of \ref ADC_Over_Write_Enable. */
    uint32_t ADC_DataLatchEdge;     /**< Specify ADC data latch edge.
                                            This parameter can be a value of \ref ADC_Latch_Data_Edge. */
    uint16_t ADC_SchIndex[16];      /**< Specify ADC mode and channel for schedule table.
                                            This parameter can be a value of \ref ADC_Schedule_Table. */
    uint16_t ADC_Bitmap;            /**< Specify the schedule table channel map.
    ...
    uint32_t ADC_DataMinusEn;       /**< Enable or disable function that adc data latched minus the given offset before writes to reg or FIFO. */
    ...
    uint32_t ADC_PowerOnMode;       /**< Specify ADC power on mode.
                                            This parameter can be a value of \ref ADC_Power_On_Mode. */
    uint32_t ADC_PowerAlwaysOnEn;   /**< Specify the power always on.
                                            This parameter can be a value of \ref ADC_Power_Always_On_Cmd. */
    uint32_t ADC_DataLatchDly;      /**< Specify delay of ck_ad to latch data.*/
    uint32_t ADC_RG2X0Dly;          /**< Specify the power on delay time selection of RG2X_AUXADC[0].
                                            This parameter can be a value of \ref ADC_RG2X_0_Delay_Time */
    uint32_t ADC_RG0X1Dly;          /**< Specify the power on delay time selection of RG0X_AUXADC[1].
                                            This parameter can be a value of \ref ADC_RG0X_1_Delay_Time */
    uint32_t ADC_RG0X0Dly;          /**< Specify the power on delay time selection of RG0X_AUXADC[0].
...
/**
 * \defgroup    ADC_Config  ADC Config
 * \{
...
/**
 * \defgroup    ADC_Data_Write_To_FIFO  ADC Data Write To FIFO
 * \{
 * \ingroup     ADC_Exported_Constants
 */
...
/**
 * \defgroup    ADC_Data_Avg_Num ADC Data Average Num
...
/**
 * \defgroup    ADC_Timer_Trigger_En ADC Timer Trigger Enable
 * \brief       Enable ADC trigger one-shot mode with TIM7.
 * \{
 * \ingroup     ADC_Exported_Constants
 */
...
#define    ADC_CONVERT_TIME_700NS                      ((uint32_t)(1 << 30))
#define    ADC_CONVERT_TIME_900NS                      ((uint32_t)(2 << 30))
#define    ADC_CONVERT_TIME_1100NS                     ((uint32_t)(3 << 30))
 ...
 * rtl876x_adc.h
 *
 * \brief Initialize the ADC peripheral according to the specified
 *     parameters in the ADC_InitStruct
 * \param[in]  ADCx: selected ADC peripheral.
 * \param[in]  ADC_InitStruct: pointer to an ADC_InitTypeDef structure that
 ...
 * \param[in]  adcMode: ADC operation mode selection.
        This parameter can be one of the following values, which refer to \ref ADC_Operation_Mode.
 ...
 * \param[in]  ADCx: Specify ADC peripheral.
 * \param[in]  ADC_INT: Specify the ADC interrupt sources to be enabled or disabled.
 *     This parameter can be any combination of the following values, which refer to \ref ADC_Interrupts_Definition.
 ...
 * rtl876x_adc.h
 *
 * \brief   Get ADC average data from ADC schedule table 0.
 * \param[in]  ADCx: Specify ADC peripheral.
 * \return  The 10 bits integer data + 2 bits fractional ADC raw data.
 * \callgraph
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * rtl876x_adc.h
 *
 * \brief   Config ADC schedule table index.
 * \param[in]  ADCx: Specify ADC peripheral.
 * \param[in]  adcMode: ADC operation mode.
 *     This parameter can be one of the following values, which refer to \ref ADC_Schedule_Table.
 ...
 * \param[in]  ADCx: Specify ADC peripheral.
 * \param[in]  bitMap: ADC channel map.
 * \param[in]  NewState: New state of the ADC peripheral.
 *      This parameter can be: ENABLE or DISABLE.
 * \return  None.
 *
 ...
 * \param[in]  ADCx: selected ADC peripheral.
 * \param[in]  ADC_INT: Specify the interrupt flag to check.
 *     This parameter can be one of the following values, which refer to \ref ADC_Interrupts_Definition.
 *     \arg ADC_INT_FIFO_OVERFLOW: ADC FIFO overflow interrupt.
 ...
 * \param[in] ADCx: Specify ADC peripheral.
 * \return  All ADC interrupt status. \ref ADC_Interrupts_Definition.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
